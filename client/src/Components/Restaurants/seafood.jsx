  ...
  return (
    <>
      ...
      <div className='row gy-4 p-0 m-0 w-75 mx-auto'>
        {/* Card */}
        {SeaFoodRes.map((res) =>
          <div key={res.id} className='shadow-sm col-md-5 mx-auto px-0 overflow-auto d-inline-block '>
            <div className=' text-center '>
              {/* Images */}
              <div className="d-flex ">
                <img className="imgHover  d-block w-100" style={{ height: "200px" }} src={res.img1} alt="img 1" />
                {/* <img className=" d-block w-100" style={{ height: "200px" }} src={res.img2} alt="img 2" /> */}
                <img className=" d-block w-100 " style={{ height: "200px" }} src={res.img3} alt="img 3" />
              </div>
              {/* Header */}
