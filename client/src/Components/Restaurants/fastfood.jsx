...
const Fastfood = () => {
  // States
  const { FastFoodRes } = useContext(DataContext);
    ...
    <>
      ...
      >
        <div className='container-fluid lightGreyBg py-3'>
          <h2 className='lightGreenColor text-center m-0'>{t("Fast Food")}</h2>
        </div>
            ...
            <div key={res.id} className='shadow-sm col-md-5 mx-auto px-0 overflow-hidden rounded-top-3'>
              <div className=' text-center '>
                ...
                <div className="d-flex ">
                  <img className="  d-inline-block w-100 rounded-top-3" style={{ height: "200px" }} src={res.img1} alt="img 1" />
                  <img className=" d-inline-block w-100 rounded-top-3" style={{ height: "200px" }} src={res.img2} alt="img 2" />
                </div>
                {/* Header */}
