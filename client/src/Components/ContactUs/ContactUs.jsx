                        ...
                        <div>
                            <form onSubmit={formik.handleSubmit} >
                                ...
                                <div className="form-group my-0">
                                    ...
                                    <input onBlur={formik.handleBlur} autoComplete="off" placeholder={t("Enter your name")} className={`form-control  mb-2 w-100  ${formik.touched.name && formik.errors.name ? styles.alert : styles.input}`} onChange={formik.handleChange} value={formik.values.name} type='text' name='name' id='name' />
