...
const Centers = () => {
  const { encodedToken, Centers } = useContext(DataContext);
                    ...
                    <div className='mt-3 d-flex flex-column align-content-center '>
                      ...
                      <div className='d-flex justify-content-center'>
                        {[...Array(parseInt(res.Rating))].map((_, index) => (
                          <i key={index} className="fa-solid fa-star fa-2x" style={{ color: '#ffc107' }} ></i>
                        ))}
                      </div>
                    </div>
                  </div> */}
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    <div className="d-flex justify-content-evenly ">
                      {/* <div className='d-flex-column '>
                        <a href={res.website}>
                        <i className="fa-solid fa-house fa-2x" style={{ color: 'green' }}></i> */}
