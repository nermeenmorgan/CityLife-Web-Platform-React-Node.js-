            ...
            <div className='shadow-sm'>
              ...
              <div className=''>
                <div className='container pt-3'>
                  ...
                  <p className='text-center'>{t(res.overview)}</p>
                </div>
                <div className='lightGreenBackgroudColor text-white  rounded-bottom-3'>
                  ...
                  <div className='text-center pb-3 '>
                    <button data-bs-target="#exampleModalToggle" data-bs-toggle="modal"
                      ...
                      data-whatever="@mdo"
                      className={i18next.language === 'en' ? "btn lightGreyBg lightGreenColor text-center w-50 rounded-1 btn-mainColor" : " btn-mainColor btn lightGreyBg w-50 lightGreenColor  text-center "}
                    >
                      {t("Feedback")}
                    </button>
                  </div>
